...
joao.lisanti@gw2:~/orelhinhas$ ^C
joao.lisanti@gw2:~/orelhinhas$ ^C
joao.lisanti@gw2:~/orelhinhas$ ^C
joao.lisanti@gw2:~/orelhinhas$ cat README.md
# Terraform modules
Each module has the most common arguments. Some modules like aws_elb for instance, I wrote two of them, one without the "ssl_certificate_id" and other with this argument (aws_modules/elb and aws_modules/elb_https).
If you want to use a github repository as a source instead local put the source in this way:
<br>
<br>
`source = "git::ssh://git@github.com/orelhinhas/terraform.git//aws_modules//name_of_module"`
...
module "keypair_orelhas" {
  source     = "./aws_modules/key_pair"
  key_name   = "orelhas"
  public_key = "ssh-rsa "
}
